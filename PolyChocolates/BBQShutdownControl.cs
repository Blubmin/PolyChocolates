...
{
    public partial class BBQShutdownControl : UserControl
    {
        Home home;
        databaseDataContext db = new databaseDataContext();

        public BBQShutdownControl(Home home)
        {
            InitializeComponent();
            this.home = home;
            setupHandlers();
        ...
        public BBQShutdownControl(Checklist checklist)
        {
            InitializeComponent();
        ...
        {
            submitBBQShutdownButton.Enabled = true;

            foreach (Control c in Table.Controls)
            {
                if (c.Text.Length == 0)
                    submitBBQShutdownButton.Enabled = false;
            }
        ...
        private void submitBBQShutdownButton_Click(object sender, EventArgs e)
        {
            Checklist checklist = new Checklist();
            checklist.Type = "bbqshutdown";
            ...
            {
                home.refreshChecklist(this, "bbqshutdown");
