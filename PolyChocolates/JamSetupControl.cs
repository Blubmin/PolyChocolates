...
{
    public partial class JamSetupControl : UserControl
    {
        Home home;
        databaseDataContext db = new databaseDataContext();

        public JamSetupControl(Home home)
        {
            InitializeComponent();
            this.home = home;
            setupHandlers();
        ...
        public JamSetupControl(Checklist checklist)
        {
            InitializeComponent();
        ...
        {
            submitJamSetupButton.Enabled = true;

            foreach (Control c in Table.Controls)
            {
                if (c.Text.Length == 0)
                    submitJamSetupButton.Enabled = false;
            }
        ...
        private void submitJamSetupButton_Click(object sender, EventArgs e)
        {
            Checklist checklist = new Checklist();
            checklist.Type = "jamsetup";
            ...
            {
                home.refreshChecklist(this, "jamsetup");
