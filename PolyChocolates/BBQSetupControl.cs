...
{
    public partial class BBQSetupControl : UserControl
    {
        Home home;
        databaseDataContext db = new databaseDataContext();

        public BBQSetupControl(Home home)
        {
            InitializeComponent();
            this.home = home;
            setupHandlers();
        ...
        public BBQSetupControl(Checklist checklist)
        {
            InitializeComponent();
        ...
        {
            submitBBQSetupButton.Enabled = true;

            foreach (Control c in Table.Controls)
            {
                if (c.Text.Length == 0)
                    submitBBQSetupButton.Enabled = false;
            }
        ...
        private void submitBBQSetupButton_Click(object sender, EventArgs e)
        {
            Checklist checklist = new Checklist();
            checklist.Type = "bbqsetup";
            ...
            {
                home.refreshChecklist(this, "bbqsetup");
