...
{
    public partial class JamShutdownControl : UserControl
    {
        Home home;
        databaseDataContext db = new databaseDataContext();

        public JamShutdownControl(Home home)
        {
            InitializeComponent();
            this.home = home;
            setupHandlers();
        ...
        public JamShutdownControl(Checklist checklist)
        {
            InitializeComponent();
        ...
        {
            submitJamShutdownButton.Enabled = true;

            foreach (Control c in Table.Controls)
            {
                if (c.Text.Length == 0)
                    submitJamShutdownButton.Enabled = false;
            }
        ...
        private void submitJamShutdownButton_Click(object sender, EventArgs e)
        {
            Checklist checklist = new Checklist();
            checklist.Type = "jamshutdown";
            ...
            {
                home.refreshChecklist(this, "jamshutdown");
